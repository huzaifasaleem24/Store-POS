...
if (auth == undefined) {
  ...
  $(document).ready(function () {
          ...
          $("<tr>").append(
            ...
            $("<td>").append(
              $("<div>", { class: "input-group" }).append(
                ...
                $("<input>", {
                  class: "form-control no-spinners m-0 p-0",
                  type: "number",
                  // class="no-spinners"
                  value: data.quantity,
    ...
    $.fn.editUser = function (index) {
      ...
      $("#password").val(allUsers[index].password);
    ...
    $("#saveUser").on("submit", function (e) {
      ...
      if (ownUserEdit) {
        ...
        if (formData.password != allUsers[user_index].password) {
          if (formData.password != formData.pass) {
            Swal.fire("Oops!", "Passwords do not match!", "warning");
          }
        }
      ...
      if (
        ...
        formData.password == allUsers[user_index].password ||
